...
export interface Builder {
	...
	/**
	 * Environment outputs generated by SvelteKit. Optional for backwards compatibility.
	 * @since 2.54.0
	 */
	environments?: BuilderEnvironment[];
	...
	/**
	 * Look up environment metadata by name (`client`, `server`, or custom environment names).
	 * Optional for backwards compatibility.
	 * @since 2.54.0
	 */
	getEnvironment?: (name: string) => BuilderEnvironment | undefined;
	/**
	 * Get the output directory for a named environment.
	 * Optional for backwards compatibility.
	 * @since 2.54.0
	 */
	getEnvironmentDirectory?: (name: string) => string;
